...
public class Server {
  ...
  private class IntervalHandler implements Route {
    ...
    public Object handle(Request req, Response res) {
      ...
      Map<String, Double> employeeIntMap = gameManager
          .calculateEmployeeIntervals();
      Map<String, Object> variables = ImmutableMap.of("customerInt", interval,
          "employeeInts", employeeIntMap);
      return GSON.toJson(variables);
    }
  }
